	...
	<main>
		<div class="row g-3">
			<div class="col-md-7 col-lg-8" style="margin: 0 auto;">
				<h4 class="mb-3" style="margin-top: 3%;">Editar História Refinada</h4>
				<form action="../../php_action/update.php" method="POST">
					...
					<div class="row g-3">
						...
						<div class="col-6">
							...
							<input type="text" class="form-control" name="responsavel" id="responsavel" placeholder="Responsável" value="<?php echo $dados['responsavel'] ?>" required>
						</div>

						<div class="col-sm-12">
							<label for="poisquero" class="form-label">Quero:</label>
							<input type="text" class="form-control" name="poisquero" id="poisquero" placeholder="poisquero" value="<?php echo $dados['poisquero'] ?>" required>
						</div>

						<div class="col-12">
							<label for="detalhamento" class="form-label">História Refinada</label>
							<input type="text" class="form-control" name="detalhamento" id="detalhamento" placeholder="" value="<?php echo $dados['detalhamento'] ?>" required>
						</div>
					...
					<div class="row" style="margin-bottom: 3%;">
						...
						<div class="col-6" style="margin-left: 0px;">
							<button class="w-100 btn btn-success btn-lg" name="btn-editarhistdetal" type="submit">Atualizar</button>
						</div>
