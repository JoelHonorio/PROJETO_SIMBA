	...
	<main>
		<div class="row g-3">
			<div class="col-md-7 col-lg-8" style="margin: 0 auto;">
				<h4 class="mb-3" style="margin-top: 3%;">Editar História</h4>
				<form action="../../php_action/update.php" method="POST">
					...
					<div class="row g-3">
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" name="quem" id="quem" placeholder="Quem?" value="<?php echo $dados['quem'] ?>" required>
						</div>

						<div class="col-6">
							<label for="gostaria" class="form-label">Gostaria de:</label>
							<input type="text" class="form-control" name="gostaria" id="gostaria" placeholder="Gostaria de:" value="<?php echo $dados['gostaria'] ?>" required>
						</div>

						<div class="col-12">
							<label for="poisquero" class="form-label" >Pois eu quero:</label>
							<input type="text" class="form-control" name="poisquero" id="poisquero" placeholder="Pois eu quero" value="<?php echo $dados['poisquero'] ?>" required>
						</div>
					...
					<div class="row" style="margin-bottom: 3%;">
						...
						<div class="col-6" style="margin-left: 0px;">
							<button class="w-100 btn btn-success btn-lg" name="btn-editarhistoria" type="submit">Atualizar</button>
						</div>
